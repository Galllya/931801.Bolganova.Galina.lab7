...
document.body.addEventListener('click', function (elem_id) {
    ...
    if (obdject.className === 'squares'
        || obdject.className === 'circles') obdject.style.background = "yellow";
    if (obdject.className === 'triangles') {
                                          if (a5 == 1) obdject.style.borderTopColor = "yellow";
                                          if (a5 == 2) obdject.style.borderLeftColor = "yellow";
                                          if (a5 == 3) obdject.style.borderRightColor = "yellow";
                                          if (a5 == 4) obdject.style.borderBottomColor = "yellow";}
}, false);
